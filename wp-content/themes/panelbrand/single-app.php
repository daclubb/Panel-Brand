<?php
	...
	// Get "Title & Text" Meta
	/*
	$appearance_info_color = get_post_meta($post->ID, 'appearance_info_color', true);
	*/
...
<section id="show-space">Yooo huus
    ...
    <div id="<?php echo $appearance_device; ?>-<?php echo $appearance_layout; ?>-box" class="application-box clearfix <?php echo $appearance_layout; ?> <?php echo $appearance_device; ?> container">
	        ...
	        <div id="application-info-box">
	            ...
	            <div class="application-market-link last">
	            	...
	            	<div class="qr-price">
            			<?php if( $show_qr == 'on' && $info_button_2_link_url != '' ): ?>
            				<img src="<?php echo get_template_directory_uri(); ?>/libs/phpqrcode/qr-generator.php?URL=<?php echo $info_button_2_link_url; ?>" alt="qr-code" />
            			<?php endif; ?>
            		</div>
	        	</div>
	       		<?php endif; ?>
	            ...
	            <?php 
	            if ( false ):
	            // if( $info_appstore_url != '' || $info_android_market_url != '' ): ?>
	            <div id="application-market-link-wrapper">	
	            	
	            	<?php if( $info_appstore_url != '' ): ?>
	            	<div class="application-market-link" id="app-store-badge">
	            		<a href="<?php echo $info_appstore_url; ?>">
	            		<img src="<?php echo get_template_directory_uri(); ?>/images/badge/app-store-badge-2.png" alt="Available on the AppStore" title="Available on the AppStore" class="store-badge" />
	            		</a>
	            		
	            		<div class="qr-price">
	            			<?php if( $show_qr == 'on' ): ?>
	            				<img src="<?php echo get_template_directory_uri(); ?>/libs/phpqrcode/qr-generator.php?URL=<?php echo $info_appstore_url; ?>" alt="qr-code" />
	            			<?php endif; ?>
	            			<div class="price-label"><?php echo $info_appstore_price; ?></div>
	            		</div>
	            		
	            	</div>
	            	<?php endif; ?>
	            	
	            	<?php if( $info_android_market_url != '' ): ?>
	            	<div id="android-market-badge" class="application-market-link last">
	            		<a href="<?php echo $info_android_market_url; ?>">
	            		<img src="<?php echo get_template_directory_uri(); ?>/images/badge/android-market-badge-2.png" alt="Available in Android Market" title="Available in Android Market" class="store-badge" />
	            		</a>
	            		     	
	            		<div class="qr-price">
	            			<?php if( $show_qr == 'on' ): ?>  
	            				<img src="<?php echo get_template_directory_uri(); ?>/libs/phpqrcode/qr-generator.php?URL=<?php echo $info_android_market_url; ?>" alt="qr-code" />
	            			<?php endif; ?>
	            			<div class="price-label"><?php echo $info_android_market_price; ?></div>
	            		</div>
