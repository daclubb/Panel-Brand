<?php
	...
	// Get "App Info" Meta	
	$product_category = wp_get_post_terms($post->ID, 'portfolio_category', array("fields" => "names"));
	$info_short_desc = get_post_meta($post->ID, 'info_short_desc', true);
	$info_product_code = get_post_meta($post->ID, 'info_product_code', true);
	$info_product_size = get_post_meta($post->ID, 'info_product_size', true);
