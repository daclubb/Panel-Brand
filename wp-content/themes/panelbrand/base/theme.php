...
class Theme {
	...
	function theme_functions() {
		require_once( THEME_FUNCTIONS_DIR . '/vt-resize.php' );
	...
	function theme_scripts() {
		...
		if ( !is_admin() && !in_array( $GLOBALS['pagenow'], array( 'wp-login.php', 'wp-register.php' ) ) ){
			...
			wp_enqueue_script( 'jquery', THEME_URI . '/libs/jquery-1.7.1.min.js', false, THEME_VERSION, false  );
			...
			// jQuery Tweet
			wp_enqueue_script( 'jquery-tweet', THEME_URI . '/libs/jquery.tweet.js', false, THEME_VERSION, true );
			...
			// Elastic Slide
			wp_enqueue_script( 'jquery-elastic', THEME_URI . '/libs/elastic-slide/jquery.elastislide.js', false, THEME_VERSION, true );
			
			// Fitvid
			wp_enqueue_script( 'jquery-fitvid', THEME_URI . '/libs/jquery.fitvids.js', false, THEME_VERSION, true );

			// jQuery Rotate Scale
			wp_enqueue_script( 'jquery-transform', THEME_URI . '/libs/jquery-css-transform.js', false, THEME_VERSION, true );
			wp_enqueue_script( 'jquery-rotate-scale', THEME_URI . '/libs/jquery-animate-css-rotate-scale.js', false, THEME_VERSION, true );
