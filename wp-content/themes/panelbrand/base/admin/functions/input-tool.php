...
class input_tool {
	...
	function image( $option ) {
		...
		if( $value ) {
			$resized_image_src = theme_get_image( $value, null, 80, true );
		...
		echo '<div class="ajax-load-icon upload-image-bt-ajax-load"></div>';
		echo '<div class="upload-image-bt-box"></div>';
	}
	...
	function images( $option ) {
		...
		foreach ( $value as $image ) {
			$resized_image_src = theme_get_image( $image, null, 80, true );
			echo '<div class="uploaded-image">';
			echo '<img src="' . $resized_image_src . '" />';
			echo '<a class="remove" href="#">remove</a>';
		...
		echo '<div class="clear"></div>';
		echo '<div class="ajax-load-icon upload-image-bt-ajax-load"></div>';
		echo '<div class="upload-images-bt-box"></div>';
	}
