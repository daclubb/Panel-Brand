...
<div id="theme-box" class="wrap">
	...
	<div id="theme-box-head">
		...
		<h2><?php _e('Theme Setting', 'theme_admin'); ?></h2>
	</div>
		...
		<div id="theme-box-tabs">
			<ul>
				...
				foreach( $sections as $section_slug => $section ): ?>
					<li class="icon-setting <?php echo ($counter++ == 0) ? 'active' : ''; ?>"><a href="#<?php echo $section_slug; ?>" class="icon-16-default icon-16-<?php echo $section_slug; ?>"><?php echo $section; ?></a></li>
				<?php endforeach; ?>
			</ul>
		</div>
	...
	<div id="theme-box-foot">
		...
		-->
		<input type="button" name="save" value="Save Options" class="button-primary" id="theme-options-save" />
	</div>
