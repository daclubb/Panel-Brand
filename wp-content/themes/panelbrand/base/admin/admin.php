...
class Theme_admin {
	...
	function custom_login_logo() {
		if( theme_options('appearance', 'branding_admin_logo') != '' ) {
			...
			echo '<style type="text/css">#login h1 a { background-image:url('. theme_get_attachment_src( theme_options("appearance", "branding_admin_logo") ) .') !important; margin: 0 auto; width: '.$logo_size[0].'px; height: '.$logo_size[1].'px !important; } </style>';
		}
	}
